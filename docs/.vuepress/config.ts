...
const DOMAIN_NAME = 'puddingkc.com' // 域名 (不带https)
...
export default defineConfig4CustomTheme<VdoingThemeConfig>({
  ...
  locales: {
    '/': {
      lang: 'zh-CN',
      title: "PuddingKC's Blog",
      description: '布丁的个人日常 & 技术开发博客。',
    }
  },
  ...
  themeConfig: {
    ...
    repo: 'Null-K/puddingkc-blog', // 导航栏右侧生成Github链接
    ...
    author: {
      name: 'PuddingKC', // 必需
      link: 'https://github.com/Null-K', // 可选的
    },
